<template>
  <Card>
    ...
    <CardContent>
      <ChartContainer :config="chartConfig" class="aspect-auto h-[160px] w-full">
        <VisXYContainer :data="chartData" :margin="{ left: -24 }" :y-domain="[0, undefined]">
          <VisLine :x="(d: Data) => d.date" :y="(d: Data) => d.desktop" :color="chartConfig.desktop.color" :curve-type="CurveType.Natural" />
          <VisAxis
            type="x"
            :x="(d: Data) => d.date"
            :tick-line="false"
