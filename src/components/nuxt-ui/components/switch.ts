export default {
  slots: {
    ...
    base: ['inline-flex items-center shrink-0 rounded-full cursor-pointer! border-2 border-transparent focus-visible:outline-2 focus-visible:outline-offset-2 data-[state=unchecked]:bg-accented', 'transition-[background] duration-200'],
    ...
    wrapper: 'ms-2',
    label: 'block font-medium cursor-pointer! text-default',
