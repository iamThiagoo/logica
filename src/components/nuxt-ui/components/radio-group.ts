export default {
  slots: {
    ...
    wrapper: 'w-full',
    label: 'block font-medium text-default cursor-pointer btn-scale',
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      variant: 'table',
      class: {
        item: 'has-data-[state=checked]:bg-primary/10 has-data-[state=checked]:border-primary/50 has-data-[state=checked]:z-[1] cursor-pointer btn-scale',
      },
    },
    {
      color: 'neutral',
